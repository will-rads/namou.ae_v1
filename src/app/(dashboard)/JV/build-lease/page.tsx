...
interface Inputs {
  ...
  softCostPct: number;
  rentalPerNSA: number;       // AED / sqft / year
  occupancy: number;           // %
  operatingCostPct: number;    // % of gross rental
  maintenancePct: number;      // % of gross rental
  propertyMgmtFeePct: number;  // % of gross rental
  holdYears: number;
  capRate: number;             // % — for optional exit valuation
