...
export default function OverviewPage() {
  return (
    <div className="flex flex-col flex-1 gap-3 lg:gap-5 animate-fade-in min-h-0 overflow-y-auto md:overflow-hidden">
      ...
      <div className="flex flex-col flex-1 min-h-0">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 flex-1 auto-rows-fr">
          {landCategories.map((cat) => (
            ...
            >
              <ContentCard className="w-full transition-all group-hover:border-forest/30 group-hover:shadow-md flex flex-col">
